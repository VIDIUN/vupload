...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.reportAdmin
{
	import com.vidiun.vo.VidiunString;VidiunString;;
	...
	{
		public function ReportAdminGetParametersDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
