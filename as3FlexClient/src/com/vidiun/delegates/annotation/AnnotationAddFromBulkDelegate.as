...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.annotation
{
	...
	import com.vidiun.commands.annotation.AnnotationAddFromBulk;
	...
	public class AnnotationAddFromBulkDelegate extends WebDelegateBase
	{
		...
		public function AnnotationAddFromBulkDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
