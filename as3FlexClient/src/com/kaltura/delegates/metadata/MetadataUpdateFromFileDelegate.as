...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.metadata
{
	...
	import com.vidiun.commands.metadata.MetadataUpdateFromFile;
	...
	public class MetadataUpdateFromFileDelegate extends WebDelegateBase
	{
		...
		public function MetadataUpdateFromFileDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
