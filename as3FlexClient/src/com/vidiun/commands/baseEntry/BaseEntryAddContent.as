...
package com.vidiun.commands.baseEntry
{
	...
	import com.vidiun.delegates.baseEntry.BaseEntryAddContentDelegate;
	 ...
	 * 
	 **/
	public class BaseEntryAddContent extends VidiunCall
	{
		 ...
		 **/
		public function BaseEntryAddContent( entryId : String,resource : VidiunResource )
		{
			service= 'baseentry';
			action= 'addContent';
