...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.thumbParams
{
	import com.vidiun.vo.VidiunThumbParams;VidiunThumbParams;;
	...
	{
		public function ThumbParamsGetByConversionProfileIdDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
