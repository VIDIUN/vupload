...
package com.vidiun.commands.thumbAsset
{
	...
	import com.vidiun.delegates.thumbAsset.ThumbAssetGenerateDelegate;
	import com.vidiun.net.VidiunCall;

	/**
	 **/
	public class ThumbAssetGenerate extends VidiunCall
	{
		 ...
		 **/
		public function ThumbAssetGenerate( entryId : String,thumbParams : VidiunThumbParams,sourceAssetId : String = null )
		{
			service= 'thumbasset';
			action= 'generate';
