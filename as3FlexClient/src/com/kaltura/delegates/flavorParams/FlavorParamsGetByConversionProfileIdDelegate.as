...
{
	import com.vidiun.vo.VidiunFlavorParams;VidiunFlavorParams;;
	...
	{
		public function FlavorParamsGetByConversionProfileIdDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
