...
package com.vidiun.vo
{
	...
	[Bindable]
	public dynamic class VidiunModerationFlag extends BaseFlexVo
	{
		/**
		 * Moderation flag id
		 * 
		 ...
		 * 
		 * @see com.vidiun.types.VidiunModerationObjectType
		 **/
		 ...
		 * 
		 * @see com.vidiun.types.VidiunModerationFlagStatus
		 **/
		...
		/**
		 * @see com.vidiun.types.VidiunModerationFlagType
		 **/
