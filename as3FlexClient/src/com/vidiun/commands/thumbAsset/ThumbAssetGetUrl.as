...
package com.vidiun.commands.thumbAsset
{
	...
	import com.vidiun.delegates.thumbAsset.ThumbAssetGetUrlDelegate;
	 ...
	 * 
	 **/
	public class ThumbAssetGetUrl extends VidiunCall
	{
		 ...
		 **/
		public function ThumbAssetGetUrl( id : String,storageId : int=int.MIN_VALUE,thumbParams : VidiunThumbParams=null )
		{
			service= 'thumbasset';
			action= 'getUrl';
