...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.thumbAsset
{
	import com.vidiun.vo.VidiunThumbAsset;VidiunThumbAsset;;
	...
	{
		public function ThumbAssetGetByEntryIdDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
