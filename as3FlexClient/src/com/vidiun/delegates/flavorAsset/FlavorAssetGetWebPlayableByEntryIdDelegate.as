...
{
	import com.vidiun.vo.VidiunFlavorAsset;VidiunFlavorAsset;;
	...
	{
		public function FlavorAssetGetWebPlayableByEntryIdDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
