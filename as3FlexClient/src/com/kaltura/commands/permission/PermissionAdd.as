...
package com.vidiun.commands.permission
{
	...
	import com.vidiun.delegates.permission.PermissionAddDelegate;
	 ...
	 * 
	 **/
	public class PermissionAdd extends VidiunCall
	{
		 ...
		 **/
		public function PermissionAdd( permission : VidiunPermission )
		{
			service= 'permission';
			action= 'add';
