...
package com.vidiun.commands.document
{
	...
	import com.vidiun.delegates.document.DocumentAddFromEntryDelegate;
	 ...
	 * 
	 **/
	public class DocumentAddFromEntry extends VidiunCall
	{
		 ...
		 **/
		public function DocumentAddFromEntry( sourceEntryId : String,documentEntry : VidiunDocumentEntry=null,sourceFlavorParamsId : int=int.MIN_VALUE )
		{
			service= 'document';
			action= 'addFromEntry';
