...
package com.vidiun.vo
{
	...
	[Bindable]
	public dynamic class VidiunPartner extends BaseFlexVo
	{
		/**
		 **/
		...
		/**
		 * @see com.vidiun.types.VidiunCommercialUseType
		 **/
		...
		/**
		 * @see com.vidiun.types.VidiunPartnerType
		 **/
		...
		/**
		 * @see com.vidiun.types.VidiunPartnerStatus
		 **/
