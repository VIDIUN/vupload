...
{
	import com.vidiun.vo.VidiunPlayerEmbedCodeType;VidiunPlayerEmbedCodeType;;
	...
	{
		public function SystemPartnerGetPlayerEmbedCodeTypesDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
