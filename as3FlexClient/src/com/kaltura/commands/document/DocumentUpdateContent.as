...
package com.vidiun.commands.document
{
	...
	import com.vidiun.delegates.document.DocumentUpdateContentDelegate;
	 ...
	 * 
	 **/
	public class DocumentUpdateContent extends VidiunCall
	{
		 ...
		 **/
		public function DocumentUpdateContent( entryId : String,resource : VidiunResource,conversionProfileId : int=int.MIN_VALUE )
		{
			service= 'document';
