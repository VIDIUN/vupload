...
// @ignore
// ===================================================================================================
package com.vidiun.delegates.document
{
	...
	import com.vidiun.commands.document.DocumentUpload;
	...
	public class DocumentUploadDelegate extends WebDelegateBase
	{
		...
		public function DocumentUploadDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
