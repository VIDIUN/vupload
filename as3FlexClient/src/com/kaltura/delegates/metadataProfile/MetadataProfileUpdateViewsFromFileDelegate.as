...
package com.vidiun.delegates.metadataProfile
{
	...
	import com.vidiun.commands.metadataProfile.MetadataProfileUpdateViewsFromFile;
	...
	public class MetadataProfileUpdateViewsFromFileDelegate extends WebDelegateBase
	{
		...
		public function MetadataProfileUpdateViewsFromFileDelegate(call:VidiunCall, config:VidiunConfig)
		{
			super(call, config);
		}
